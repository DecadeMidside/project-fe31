    ...
    <S.Container>
      ...
      <Row gutter={[16, 32]}>
        <Col span={16} style={{ minHeight: "500px" }}>
          <S.styleProductItem>
            <img
              src="https://www.breitling.com/media/image/3/cfg_site/asset-version-6ae8d185ce/ab01763a1c1x1-top-time-b01-shelby-cobra-soldier.png"
              alt=""
            />

            <S.ProductInf>
              <h3>TOP TIME B01 SHELBY COBRA</h3>
              <span>Remove</span>
      ...
      <S.styledCollapse accordion expandIconPosition="end">
        ...
        <S.styleLabel header="How do I claim my gift with purchase?" key="1">
          <p>
            ...
            Breitling.com, and we'll show our appreciation with a gift from our
            range of lifestyle and travel accessories. Your selected gift will
            be sent separately, approximately 45 days after you have received
            your order.
          </p>
        </S.styleLabel>
        <S.styleLabel
        ...
        >
          <p>
            ...
            "Pre-Order Now" link are available for purchase online. Simply click
            the link to get started.
          </p>
        </S.styleLabel>
        <S.styleLabel header="HOW QUICKLY WILL I RECEIVE MY ORDER?" key="3">
          <p>
            Standard delivery is 2-3 business days for watches and 3-5 business
            days for all other orders once your order is confirmed. A signature
